...
const CustomerLayout = () => {
  ...
  const iconMap = {
    ...
    "book-shipment": <Package className="w-3 h-3 sm:w-4 sm:h-4" />,
    "my-bookings": <BookOpen className="w-3 h-3 sm:w-4 sm:h-4" />,
    "track-shipment": <MapPin className="w-3 h-3 sm:w-4 sm:h-4" />,
    profile: <User className="w-3 h-3 sm:w-4 sm:h-4" />,
  };
