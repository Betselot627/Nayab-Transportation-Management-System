...
const DriverLayout = () => {
  ...
  const iconMap = {
    ...
    "my-trips": <Map className="w-3 h-3 sm:w-4 sm:h-4" />,
    "my-vehicles": <Truck className="w-3 h-3 sm:w-4 sm:h-4" />,
    "register-vehicle": <Truck className="w-3 h-3 sm:w-4 sm:h-4" />,
    "trip-details": <FileText className="w-3 h-3 sm:w-4 sm:h-4" />,
    "update-status": <Activity className="w-3 h-3 sm:w-4 sm:h-4" />,
  };
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden lg:ml-0">
        ...
        <header className="sticky top-0 z-30 flex items-center justify-between gap-2 sm:gap-4 px-3 sm:px-6 py-3 bg-white/90 backdrop-blur-md border-b border-gray-200 shadow-sm">
          ...
          <div className="flex items-center gap-1 text-xs sm:text-sm text-gray-500 overflow-x-auto">
            <span className="capitalize text-[10px] sm:text-xs font-semibold px-2 py-0.5 rounded bg-green-100 text-green-700 whitespace-nowrap">
              Driver
            </span>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3 border-l border-gray-200 pl-2 sm:pl-4">
              ...
              <div className="w-8 h-8 sm:w-9 sm:h-9 bg-green-600 rounded-full flex items-center justify-center text-white font-bold ring-2 ring-green-500/20 shadow-inner text-sm">
                {user?.name ? (
